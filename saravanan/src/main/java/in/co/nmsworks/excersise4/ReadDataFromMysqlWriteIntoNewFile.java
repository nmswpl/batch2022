...
public class ReadDataFromMysqlWriteIntoNewFile
{
    ...
    {
         try(FileWriter writeMaleDetails = new FileWriter("/home/nmsadmin/Downloads/userdetailsofmaleonly.txt");
             FileWriter writeFemaleDetails = new FileWriter("/home/nmsadmin/Downloads/userdetailsfemaleonly.txt");
             ...
             while (resultTable.next())
             {
                // int sqlColumn1 = resultTable.getInt(1);
                 ...
                 if(sqlColumn5.equalsIgnoreCase("male"))
                      writeMaleDetails.write(sqlColumn2+"  "+sqlColumn3 +" "+sqlColumn4+" "+sqlColumn5+"\n");
                 else
                     writeFemaleDetails.write(sqlColumn2+"  "+sqlColumn3 +" "+sqlColumn4+" "+sqlColumn5+"\n");
             }
         }
         catch (Exception e)
         {
