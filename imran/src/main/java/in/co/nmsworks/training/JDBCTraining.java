...
public class JDBCTraining {
    ...
    private static void update() throws SQLException {
        ...
        try {
            ...
            String[] query = {"insert into TodoList values(1,'imran','Wakeup','2001-06-30 12:10:00')",
                    "insert into TodoList values(2,'Vikky','Bought','2000-10-05 11:10:00')",
                    ...
                    "insert into TodoList values(5,'Keerthana','Lunch','2004-12-17 01:10:28')"};
